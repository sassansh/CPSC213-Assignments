...
int exec() {
  static const void* jt[]  = {&&L0, &&L1, &&L2, &&L3, &&L4, &&DEFAULT, &&L6, &&L7, &&L8,
                              &&L9, &&LA, &&LB, &&LC, &&LD, &&LE, &&LF};
  static const void* jt6[] = {&&L6_0, &&L6_1, &&L6_2, &&L6_3, &&L6_4, &&L6_5, &&L6_6, &&L6_7, 
                              &&DEFAULT_6, &&DEFAULT_6, &&DEFAULT_6, &&DEFAULT_6, &&DEFAULT_6,
                              &&DEFAULT_6, &&DEFAULT_6, &&L6_F};
